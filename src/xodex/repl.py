...
def _print_welcome():
    ...
    print("   • Digite \033[96m/help\033[0m para ver todos os comandos")
    print("   • Use \033[92m/agent\033[0m para modo agente")
    print("   • Use \033[95m/ask\033[0m para perguntas rápidas")
    print()
    print("─" * 50)
    print()
                ...
                try:
                    for chunk in stream_obj:  # type: ignore
                        ...
                        if delta:
                            ...
                            if not reasoning_started and (
                                "vou" in delta.lower()
                                or "i'll" in delta.lower()
                                or "i'm" in delta.lower()
                                or "estou" in delta.lower()
                            ):
                                in_reasoning = True
                            ...
                            if in_reasoning and (
                                "aqui está" in delta.lower()
                                or "here is" in delta.lower()
                                or "a resposta é" in delta.lower()
                                or "the answer is" in delta.lower()
                                or "encontrei" in delta.lower()
                                or "found" in delta.lower()
                            ):
                                in_reasoning = False
                    ...
                    async for chunk in stream_obj:
                        try:
                            ...
                            if not reasoning_started and (
                                "vou" in chunk_text.lower()
                                or "i'll" in chunk_text.lower()
                                or "i'm" in chunk_text.lower()
                                or "estou" in chunk_text.lower()
                            ):
                                in_reasoning = True
                                reasoning_started = True
                                print("\033[90m", end="", flush=True)  # Cinza
                            ...
                            if in_reasoning and (
                                "aqui está" in chunk_text.lower()
                                or "here is" in chunk_text.lower()
                                or "a resposta é" in chunk_text.lower()
                                or "the answer is" in chunk_text.lower()
                                or "encontrei" in chunk_text.lower()
                                or "found" in chunk_text.lower()
                            ):
                                in_reasoning = False
                                print("\033[0m", end="", flush=True)  # Reset cor
